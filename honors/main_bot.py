...
class BotHandler(object):
    ...
    def get_updates(self, offset=None, timeout=30):
        ...
        try:
            ...
            logging.info("Failed to parse response {}: {}.".format(raw_resp.content, e))
            return []
    ...
    def get_answer(self, question):
        if question == '/start':
            return "Hi, I am not your project bot,taken. How can I help you today?"
...
def main():
    ...
    if not token:
        if not "TELEGRAM_TOKEN" in os.environ:
            ...
            logging.ingo("Please, set bot token through --token or TELEGRAM_TOKEN env variable")
            return
